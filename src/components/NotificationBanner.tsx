...
export function NotificationBanner() {
  ...
  return (
    <div
      ...
      className="absolute left-2 right-2 top-2 z-50 flex items-center gap-2.5 rounded-2xl bg-white/95 p-3 text-left shadow-lg ring-1 ring-black/5 backdrop-blur"
