...
{"messages":[{"type":"text","content":"自然聊天内容"}],"mood":"简短心情","thought":"不超过100字的真实想法","knowledgeQueries":[],"outfitChanges":[],"review":{"valid":true,"reason":"已检查人设、时间因果、已知事实、地点和承诺边界"},"specialTask":{"decision":"none","reason":"没有形成需要实际执行的线下安排"}}
...
outfitChanges 只在角色本轮已经实际换好、穿上或脱下衣物时填一项：[{"items":[{"name":"衣物名","category":"上装","color":"颜色","description":"描述"}],"summary":"更改后的完整穿着"}]。items 必须是更改后实际穿在身上的完整组合。只是讨论、建议、未来打算、描述原有穿着或没有执行时必须保持空数组。
...
固定结构：{"messages":[{"speakerIndex":1,"speakerName":"姓名","type":"text","content":"消息","thought":"真实想法","mood":"心情"}],"turnSummary":"一句话总结","knowledgeQueries":[],"planCandidates":[],"outfitChanges":[],"review":{"valid":true,"reason":"已检查人物、事实与时间因果"}}
...
outfitChanges 只记录本轮已实际完成的换穿，每项必须填 speakerIndex、更改后完整 items（name/category/color/description）和 summary；讨论、建议、未来打算或未执行的请求保持空数组。
