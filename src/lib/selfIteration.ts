...
1. globalPrompt：全局用户相处模型，所有AI联系人都会复用。只包含：
- 表达习惯：口癖、常用词、语气词、标点、句长、语气、结构习惯。不要写表情包，也不要写“短句连发”。
- 交流方式：用户喜欢被怎样接话、分析、安慰、反驳、推进；是否讨厌机械追问、过度正式、空泛总结等。
- 用户期望模型：从用户表现推测“用户期待AI如何回应”。满意/继续展开/修正/负面情绪都要作为证据；负面情绪通常意味着某个期望没有被满足。

2. contactPrompt：只给联系人“${opts.contact.name}”使用。只包含：
- 对用户下一句话的预期：用户接下来可能补充、否定、换方向、表达情绪还是要求落地；预期之内自然回应，明显预期之外可以轻微惊讶或迟疑。
