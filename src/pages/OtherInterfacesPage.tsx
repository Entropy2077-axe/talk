  ...
  return (
    <div className="flex h-[var(--app-height)] flex-col overflow-hidden bg-[var(--ui-bg)]">
      ...
      <div className="flex-1 overflow-y-auto pb-8">
        ...
        <section className="mx-3 rounded-[var(--ui-radius-card)] bg-[var(--ui-surface)] px-4 shadow-[var(--ui-shadow)]">
        ...
        <section className="mx-3 rounded-[var(--ui-radius-card)] bg-[var(--ui-surface)] px-4 py-4 shadow-[var(--ui-shadow)]">
